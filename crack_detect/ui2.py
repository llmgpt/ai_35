...
class RoadDamageDetectionApp(QWidget):
    ...
    def load_weights(self):
        file_path, _ = QFileDialog.getOpenFileName(self, "选择权重文件", "", "权重文件 (*.pth *.pt *.h5 *.pdparams)")
        if file_path:
    ...
    def show_detection_image(self):
        # 保存分割结果的路径
        self.detection_image_path = r'C:\1workspace\ai_35\crack_detect\img\20160222_164000_641_1.png'
